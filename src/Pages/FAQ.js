        ...
        <div className="col-lg-12">
          <div className="breadcrumb-inne">
            <div className="title-area">
              <h1 className="bread-title">Got Questions?</h1>
    ...
    <div className="container">
      <div className="row g-5">
        <div className="col-lg-4">
          {/* left contact form */}
          <form className="contact-page-form" action="#">
        ...
        <div className="col-lg-8 pl--140 pl_md--15 pl_sm--15">
          <div className="accordion-area-one">
            <h4 className="title mb--25">Some frequently asked questions</h4>
